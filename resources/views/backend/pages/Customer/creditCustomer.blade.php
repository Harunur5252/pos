            ...
            <div class="card">
              <div class="card-header">
                <h3>
                    ...
                    <a class="btn btn-success btn-sm float-right" href="{{route('customers.credit.pdf')}}"><i class="fa fa-download"></i>&nbsp;Download Pdf</a>
                </h3>
              </div>
              <div class="card-body">
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Credit Customer DataTable</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <tbody>
                          ...
                          @endphp
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('edit.invoice',[$payment->invoice_id])}}" class="btn btn-primary btn-sm">Edit</a>
