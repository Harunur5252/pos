...
<head>
    ...
    <title>Supplier Wise Product Stock Pdf</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
           <div class="col-md-12">
              <table width="100%">
                  <tbody>
                      <tr>
                          <td style="text-align: center;"><strong><u>Supplier Wise Product Stock</u></strong></td>
                      </tr>
                  </tbody>
              </table>
           </div>
        ...
        <div class="row">
          <div class="col-md-12">
              <strong>Supplier Name : </strong>{{$allProducts['0']->supplier->name}}
